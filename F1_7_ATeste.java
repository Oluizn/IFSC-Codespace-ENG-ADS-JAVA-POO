...
public class F1_7_ATeste {
    public static void main(String[] args) {
        ...
        int[] numeros = {-3,-15, 5, 2, 8, 1, 9, 3, 7, 4, 6};
        ...
        System.out.println("\nParallel Sort do Array, ordenação do array de acordo com a ordem natural dos elementos" + Arrays.toString(numeros));

        //CopyOf range
        int[] numerosCopia3 = Arrays.copyOfRange(numeros, 2, 5);
        System.out.println("\nO array resultante da copia do primeiro array do indice 2 até o 5:" + Arrays.toString(numerosCopia3));
